...
class TRootMutationType {
  TRootMutationType({this.projectAddBalanceWithStripe,
    this.userSetSkills,
...
abstract class TMutation {
  ...
  Future<dynamic> projectAddBalanceWithStripe({String amount,
    String cardToken,
    String creditCardId,
...
""", variables: {"input": input.toJson()});
  ...
  /// If you're just reordering the list relative to siblings, set this to the current parent.
  ///
  Future<TCard> cardMove({String afterId,
    String beforeId,
    String cardId,
    String toId,
...
""", variables: {"input": input.toJson()});
  ...
  Future<dynamic> contractStart({String contractId,
    String contractorHourlyRate,
    String contractorId,
    String customerHourlyRate,
    String projectId}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<dynamic> updateAvailability({String endDate,
    String projectId,
    String startDate,
    bool timePerWeek,
    String userId}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardDueDateSet({String cardId,
    String dueDate,
      String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardAssign({String assigneeId,
    String cardId,
      String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  ///
  /// [cardId]  The card to increase the budget for
  Future<TCard> cardBudgetIncrease({bool budgetDuration,
    String cardId,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<dynamic> accountTransfer({String amount,
    String destAccount,
    String memo,
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardDueDateUnset({String cardId,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardUncomplete({String cardId,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TUser> cardInviteUser({String cardId,
    String email,
    String fragment =
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardEstimateSet({String cardId,
    String estimate,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardUndelete({String cardId,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
...
""", variables: {"input": input.toJson()});
  ...
  Future<TCard> cardRename({String cardId,
    String cardName,
    String fragment = """fragment DemoCard on Card { assigneeId budget 
      completed completedAt } """}) async {
